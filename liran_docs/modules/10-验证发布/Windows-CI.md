...
2026-07-30 运行 `30532375079`、`30533952523` 和 `30534313119` 均在 `npm test` 阶段通过 58/59 项。第三次确认点击动作本身可能跨过 `queued`；现已将观察 promise 前置到 `submit.click()` 前并完成本机回归，仍需新的 Windows Actions 绿色运行才能把 T39 标记为真机测试通过。
