import { managerContractVersion, membershipLabels, loginLabels, browserLabels } from "./ui-contracts.js";
...
function renderImages() {
  ...
  else if (!records.length) content = imageState(result?.total === 0 ? "该 Profile 暂无图片" : "没有符合当前筛选条件的图片");
